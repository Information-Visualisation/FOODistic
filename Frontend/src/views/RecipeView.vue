...
<template>
    ...
    <div class="collapse" id="collapseExample">
        These are all the ingredients/foods used in this recipe. Here we can go to the foodview of a food in question by
        clicking on this fooditem.
    </div>
    <div class="d-flex justify-content-center">
        <div class="row">
            <FoodItem v-for="food in recipe" :name=food.foodname :id="food.foodid.toString()" :comparing="comparing"
    ...
    <div class="collapse" id="collapseExample">
        Here are the allergies linked to this recipe. Hovering over the allergy icon will show the name of the allergy. This
        is useful for when we are dealing with the general icon for the less prevelant allergies.
    </div>
    <div class="d-flex justify-content-center">
    ...
    <div class="collapse" id="collapseExample">
        Here are the cooking techniques used in this recipe. We can hover over the icon to get an explanation of the cooking
        technique.
    </div>
    <h2>Nutrients:</h2>
    <div class="d-flex justify-content-center">
